  ...
  return (
    <div id="page-personal" className={styles.page}>
      <div className={styles.container}>
        ...
        <p>I also spend a lot of time imagining funny website interactions like this site, most of stay in my head, some of them don't make it past Sketch, but I enjoy trying to figure out how to create them.</p>
      </div>
    </div>
  )
}