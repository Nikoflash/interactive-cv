...
export default ({handleTouchStart, handleTouchEnd, scrollLength}) => {
  ...
  return (
    <div id="epre" className={styles.experience}>
      <Experience handleTouchStart={handleTouchStart} handleTouchEnd={handleTouchEnd} pageY={pageY} scrollLength={scrollLength} />
      <Slider setPageY={setPageY} scrollLength={scrollLength}/>
    </div>
  )
}

const Experience = ({handleTouchStart, handleTouchEnd, pageY, scrollLength}) => {


  useEffect(() => {
    new TweenLite.set('#xp', { css: { opacity: 1 } });
    new TweenLite.set('#xp-e12, #xp-e22, #xp-e32, #xp-e42', { y: 74 });
    new TweenLite.set('#xp-e13, #xp-e23, #xp-e33, #xp-e43', { y: 37 });
    new TweenLite.set('#xp-x1, #xp-e11, #xp-e21,  #xp-e31, #xp-n1', { rotation: 90, transformOrigin: '0 100%' });
    new TweenLite.set('#xp-e41, #xp-x2', { rotation: -90, transformOrigin: '0 100%' });
    new TweenLite.set('#xp-p', { rotation: 53, y: '8', transformOrigin: '0 100%' });
    new TweenLite.set('#xp-r1', { rotation: -90, transformOrigin: '0 100%' });
    new TweenLite.set('#xp-n2', { rotation: -63, transformOrigin: '100% 100%' });
    new TweenLite.set('#xp-c', { rotation: -50, transformOrigin: '100% 100%' });
    new TweenLite.set('#xp-r2', { rotation: 53, transformOrigin: '0 100%' });
    new TweenLite.set('#xp-i', { rotation: 90, transformOrigin: '0 100%' });
  }, [])
  ...
  useLayoutEffect(() => {
    ...
    new TweenLite.to('#xp-e12, #xp-e22, #xp-e32, #xp-e42', 0.5, {
      y: 74-((74/scrollLength)*pageY),
      ease: Power2.easeOut
    })
  
    new TweenLite.to('#xp-e13, #xp-e23, #xp-e33, #xp-e43', 0.5, {
      y: 37-((37/scrollLength)*pageY),
      ease: Power2.easeOut
    })
  
    new TweenLite.to('#xp-x1', 0.5, {
      rotation: 90-((63/scrollLength)*pageY), 
      transformOrigin: '0 100%',
      ease: Power2.easeOut
    })
  
    new TweenLite.to('#xp-x2', 0.5, {
      rotation: -90+((63/scrollLength)*pageY), 
      transformOrigin: '0 100%',
      ease: Power2.easeOut
    })
  
    new TweenLite.to('#xp-e11, #xp-e21,  #xp-e31, #xp-n1', 0.5, {
      rotation: 90-((90/scrollLength)*pageY), 
      transformOrigin: '0 100%',
      ease: Power2.easeOut
    })
  
    new TweenLite.to('#xp-e41', 0.5, {
      rotation: -90+((90/scrollLength)*pageY), 
      transformOrigin: '0 100%',
      ease: Power2.easeOut,
    })
  
    new TweenLite.to('#xp-p', 0.5, {
    ...
    new TweenLite.to('#xp-r1', 0.5, {
      rotation: -90+((35/scrollLength)*pageY), 
      transformOrigin: '0 100%',
      ease: Power2.easeOut
    })
  
    new TweenLite.to('#xp-r2', 0.5, {
      rotation: 53-((53/scrollLength)*pageY), 
      transformOrigin: '0 100%',
      ease: Power2.easeOut
    })
  
    new TweenLite.to('#xp-i', 0.5, {
      rotation: 90-((90/scrollLength)*pageY), 
      transformOrigin: '0 100%',
      ease: Power2.easeOut
    })
  
    new TweenLite.to('#xp-n2', 0.5, {
      rotation: -63+((63/scrollLength)*pageY), 
      transformOrigin: '100% 100%',
      ease: Power2.easeOut
    })
  
    new TweenLite.to('#xp-c', 0.5, {
  ...
  return (
    <svg id="xp" className={styles.xp} viewBox="0 0 510 95" version="1.1" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect id="experienceButton" className={styles.button} x="0" y="0" width="100%" height="100%" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} />
    </svg>
  )
}